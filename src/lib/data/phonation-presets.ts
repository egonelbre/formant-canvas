...
export const PHONATION_PRESETS: Record<PhonationMode, PhonationPreset> = {
  breathy: { label: 'Breathy', openQuotient: 0.7,  aspirationLevel: 0.15, spectralTilt: 18, rd: 2.5 },
  modal:   { label: 'Modal',   openQuotient: 0.6,  aspirationLevel: 0.03, spectralTilt: 6,  rd: 1.0 },
  flow:    { label: 'Flow',    openQuotient: 0.55, aspirationLevel: 0.02, spectralTilt: 3,  rd: 0.8 },
  pressed: { label: 'Pressed', openQuotient: 0.4,  aspirationLevel: 0.01, spectralTilt: 0,  rd: 0.3 },
};
